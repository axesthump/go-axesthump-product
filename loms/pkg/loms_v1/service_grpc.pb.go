...
type LomsV1Client interface {
	...
	OrderPayed(ctx context.Context, in *OrderPayedRequest, opts ...grpc.CallOption) (*EmptyMessage, error)
	CancelOrder(ctx context.Context, in *CancelOrderRequest, opts ...grpc.CallOption) (*EmptyMessage, error)
...
func (c *lomsV1Client) OrderPayed(ctx context.Context, in *OrderPayedRequest, opts ...grpc.CallOption) (*EmptyMessage, error) {
...
func (c *lomsV1Client) CancelOrder(ctx context.Context, in *CancelOrderRequest, opts ...grpc.CallOption) (*EmptyMessage, error) {
	out := new(EmptyMessage)
...
type LomsV1Server interface {
	...
	OrderPayed(context.Context, *OrderPayedRequest) (*EmptyMessage, error)
	CancelOrder(context.Context, *CancelOrderRequest) (*EmptyMessage, error)
...
func (UnimplementedLomsV1Server) OrderPayed(context.Context, *OrderPayedRequest) (*EmptyMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OrderPayed not implemented")
}
func (UnimplementedLomsV1Server) CancelOrder(context.Context, *CancelOrderRequest) (*EmptyMessage, error) {
