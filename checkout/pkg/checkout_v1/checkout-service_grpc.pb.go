...
type CheckoutV1Client interface {
	AddToCart(ctx context.Context, in *AddToCartRequest, opts ...grpc.CallOption) (*EmptyMessage, error)
	DeleteFromCart(ctx context.Context, in *DeleteFromCartRequest, opts ...grpc.CallOption) (*EmptyMessage, error)
...
func (c *checkoutV1Client) AddToCart(ctx context.Context, in *AddToCartRequest, opts ...grpc.CallOption) (*EmptyMessage, error) {
...
func (c *checkoutV1Client) DeleteFromCart(ctx context.Context, in *DeleteFromCartRequest, opts ...grpc.CallOption) (*EmptyMessage, error) {
	out := new(EmptyMessage)
...
type CheckoutV1Server interface {
	AddToCart(context.Context, *AddToCartRequest) (*EmptyMessage, error)
	DeleteFromCart(context.Context, *DeleteFromCartRequest) (*EmptyMessage, error)
...
func (UnimplementedCheckoutV1Server) AddToCart(context.Context, *AddToCartRequest) (*EmptyMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToCart not implemented")
}
func (UnimplementedCheckoutV1Server) DeleteFromCart(context.Context, *DeleteFromCartRequest) (*EmptyMessage, error) {
